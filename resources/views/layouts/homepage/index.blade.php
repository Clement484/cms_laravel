...
<head>
  ...
  <!-- Favicons -->
  {{-- <link href="{{ Vite::asset('resources/homepage/assets/img/favicon.png') }}" rel="icon"> --}}
  <link href=" {{ Vite::asset('resources/homepage/assets/img/apple-touch-icon.png') }}" rel="apple-touch-icon">
