        ...
        <div class="container">
          <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="100">
            <div class="col-lg-6 text-center">
              ...
              <a href="#get-started" class="btn-get-started text-decoration-none">Get Started</a>
            </div>
          </div>
        </div>
      </div>
            ...
            <form action="forms/quote.php" method="post" class="php-email-form">
              ...
              <div class="row gy-3">
                ...
                <div class="col-12 text-center">
                  ...
                  <button type="submit" disabled>Get a quote</button>
                </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item  position-relative">
              ...
              <a href="#" class="readmore stretched-link text-decoration-none">Read more <i class="bi bi-arrow-right"></i></a>
            </div>
        ...
        <div class="row justify-content-around gy-4">
          ...
          <div class="col-lg-5 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="500">
              ...
              <div>
                <h4><a href="" class="stretched-link text-decoration-none">Dine Pad</a></h4>
            ...
            <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="600">
              <i class="bi bi-brightness-high flex-shrink-0"></i>
              <div>
                <h4><a href="" class="stretched-link text-decoration-none">Tride clov</a></h4>
      ...
      <div class="container">
        ...
        <ul class="nav nav-tabs row  g-2 d-flex" data-aos="fade-up" data-aos-delay="100" role="tablist">
          ...
          <li class="nav-item col-3" role="presentation">
            <a class="nav-link active show text-decoration-none" data-bs-toggle="tab" data-bs-target="#features-tab-1" aria-selected="true" role="tab">
              <h4>Modisit</h4>
            </a>
          </li><!-- End tab nav item -->

          <li class="nav-item col-3" role="presentation">
            <a class="nav-link text-decoration-none" data-bs-toggle="tab" data-bs-target="#features-tab-2" aria-selected="false" tabindex="-1" role="tab">
              <h4>Praesenti</h4>
            </a><!-- End tab nav item -->

          </li>
          <li class="nav-item col-3" role="presentation">
            <a class="nav-link text-decoration-none" data-bs-toggle="tab" data-bs-target="#features-tab-3" aria-selected="false" tabindex="-1" role="tab">
              <h4>Explica</h4>
            </a>
          </li><!-- End tab nav item -->

          <li class="nav-item col-3" role="presentation">
            <a class="nav-link text-decoration-none" data-bs-toggle="tab" data-bs-target="#features-tab-4" aria-selected="false" tabindex="-1" role="tab">
              <h4>Nostrum</h4>
            </a>
          </li><!-- End tab nav item -->
