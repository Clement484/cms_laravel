        ...
        <div class="row gy-5">
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="100">
            <div class="member-img">
              <img src="{{ asset('storage/'. $user->profile_photo) }}" class="img-fluid" alt="">
              <div class="social">
            ...
            <div class="member-info text-center">
              ...
              <p>{{$user->bio}}</p>
              @else
              <p>A passionate professional with a diverse skill set. Enjoys learning new things and connecting with others. Always striving for personal and professional growth.</p>
              @endif
            </div>
          </div><!-- End Team Member -->
          @endforeach
